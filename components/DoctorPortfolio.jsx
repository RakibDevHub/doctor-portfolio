...
export default function DoctorPortfolio() {
  ...
  const content = {
    bn: {
      ...
      aboutText:
        "ডাঃ মোঃ আরিফুর রহমান ঢাকা বিশ্ববিদ্যালয় থেকে BDS সম্পন্ন করে ওরাল ও ম্যাক্সিলোফেসিয়াল সার্জারিতে postgraduate প্রশিক্ষণ নিয়েছেন। তিনি বিশ্বাস করেন — সঠিক রোগ নির্ণয় ও রোগীকে যথাযথ ব্যাখ্যা দেওয়াই সফল চিকিৎসার अर्धेक।",
      aboutPoints: [
